...
<section class="container" aria-labelledby="hero_title">
	<Grid customClass="-cols-6 -gap-vm">
		...
		<Anchor customClass="col-6 col-start-1 md:col-6 md:col-start-1 lg:col-2 lg:col-start-1" variant="default" size="large" label="Take the Reality Check" href="#checklist"/>
	</Grid>
</section>

<style>
	h1 { margin-top: var(--space-500);}
	@media (min-width: 48rem) { h1 { margin-top: var(--space-max);} }
</style>