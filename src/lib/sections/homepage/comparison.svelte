		...
		<List customClass="stages col-6 col-start-1 lg:col-4 lg:col-start-2 -gap-none">
			<Box as="li" customClass="-align-top -padding-s -space-s" boxed>
				...
				<List customClass="" vertical smallgap>
					...
					<ListItem as="li" icon="checkg" label="Built for complex scientific data" customClass="-small"/>
					<ListItem as="li" icon="checkg" label="You own the system permanently" customClass="-small"/>
					<ListItem as="li" icon="checkg" label="One project at a time, full attention" customClass="-small"/>
			...
			<Box as="li" customClass="-align-top -padding-s -space-s" boxed>
				...
				<List customClass="" vertical smallgap>
					<ListItem as="li" icon="close-circle-r" label="3-6 months or longer" customClass="-small -subtle"/>
					<ListItem as="li" icon="close-circle-r" label="Generic component libraries" customClass="-small -subtle"/>
					<ListItem as="li" icon="close-circle-r" label="Ongoing retainers, no exit" customClass="-small -subtle"/>
					<ListItem as="li" icon="close-circle-r" label="Multiple projects, divided attention" customClass="-small -subtle"/>
